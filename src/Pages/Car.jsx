...
const Car = () => {
  ...
  const carData = [
    { imgSrc: car1, name: "SMART FORFOUR 1.0", price: "$24.00", details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car2, name: "FIAT 500 1.2", price: "$25.00", details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car3, name: "FIAT PANDA 1.2", price: "$26.00",details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car4, name: "MERCEDES BENZ C200",price: "$68.00", details: "Mileage unlimited 4 / Manual transmission", },
    { imgSrc: car5, name: "MERCEDES BENZ E200", price: "$75.00", details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car6, name: "AUDI A4 2.0", price: "$75.00", details: "Mileage unlimited 4 / Manual transmission", },
    { imgSrc: car7, name: "PEUGEOT 2008 GPS", price: "$58.00", details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car8, name: "GM VIVARO 2.1", price: "$90.00",details: "Mileage unlimited 4 / Manual transmission",},
    { imgSrc: car9, name: "MERCEDES BENZ V 2.1", price: "$100.00", details: "Mileage unlimited 4 / Manual transmission",},
  ];
...
<div className="flex flex-wrap items-center mb-10 ">
      <button className="px-4 sm:px-6 py-2 bg-teal-500 text-white font-semibold flex items-center gap-2 sm:gap-3 text-sm sm:text-sm">{icon1} Flights</button>
      ...
      <button className="px-4 sm:px-6 py-2 text-teal-500 bg-neutral-100 font-semibold flex items-center gap-2 sm:gap-3 text-sm sm:text-sm">{icon2} Cars</button>
    ...
    <form className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 relative p-5 ">
      {[
        { label: "Country", options: ["Please select", "Alaska", "Bahamas", "Canada"] },
        { label: "City", options: ["Please select", "Alaska", "Bahamas", "Canada"] },
        ...
        <div key={index}>
          ...
          {field.type === "date" ? (
            <input
              type="date"
              className="mt-2 w-full px-3 py-2 border  text-gray-300 focus:ring-teal-500 focus:border-teal-500"
            />
          ) : (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {carData.map((car, index) => (
        <div key={index} className="bg-gray-50 border-gray-100 p-3">
          <img src={car.imgSrc} alt="not found" className="w-full h-40 rounded mb-4" />
          <p className="text-gray-500 text-[16px] ml-2">{car.name}</p>
          <p className="text-red-500 font-bold text-[16px] ml-2">{car.price}</p>
