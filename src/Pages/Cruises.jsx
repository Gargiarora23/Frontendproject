...
const cruisesData = [
  { imgSrc: cruises1, name: "7 Days Bahamas", price: "$729.00", details: "Bahamas 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises2, name: "14 Days Mediterranean", price: "$999.00", details: "Mediterranean 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises3, name: "5 Days Carribean", price: "$360.00",details: "Caribbean 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises4, name: "4 Days Greece",price: "$236.00", details: "Greece 17 Deal Officers / Lorem ispum dolor sit amet, concateus", },
  { imgSrc: cruises5, name: "9 Days Australia", price: "$990.00", details: "Australia 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises6, name: "12 Days Mediterranean", price: "$560.00", details: "Mediterranean 17 Deal Officers / Lorem ispum dolor sit amet, concateus", },
  { imgSrc: cruises7, name: "4 Days Caribbean", price: "$36.00", details: "Caribbean 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises8, name: "4 Days Caribbean", price: "$90.00",details: "Caribbean 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
  { imgSrc: cruises9, name: "5 Days Caribbean", price: "$160.00", details: "Caribbean 17 Deal Officers / Lorem ispum dolor sit amet, concateus",},
];
...
<div className="flex flex-wrap items-center mb-10 ">
    ...
    <button className="px-4 sm:px-6 py-2 text-white bg-teal-500 font-semibold flex items-center gap-2 sm:gap-3 text-sm sm:text-sm">{icon} Hotels</button>
    ...
    <button className="px-4 sm:px-6 py-2 text-teal-500 bg-neutral-100 font-semibold flex items-center gap-2 sm:gap-3 text-sm sm:text-sm">{icon3} Cruises</button>
</div>
   
<form className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 p-5 ">
{[
    { label: "Sail To:", options: ["Please select", "Alaska", "Bahamas", "Canada"] },
    { label: "Sail From:", options: ["Please select", "Alaska", "Bahamas", "Canada"] },
    { label: "Pick up Date", type: "date"  },
    { label: "Drop off Date", type: "date" },
    { label: "Location", options: ["Please select", "Alaska", "Bahamas","Canada"] },
].map((field, index) => (
       
<div key={index}>
<label className="block  font-medium text-gray-500 mb-1">{field.label}:</label>
{field.type === "date" ? (
<input type="date" className="mt-2 w-full px-3 py-2 border  text-gray-300 focus:ring-teal-500 focus:border-teal-500"/>
) : (
<select className="mt-2 w-full px-3 py-2 border  text-gray-300 focus:ring-teal-500 focus:border-teal-500">
...
<div className='px-3 py-2'>
        <button 
          type="submit" 
          className="px-7 py-2 mt-7 mb-7 bg-teal-500 text-white font-semibold rounded-md hover:bg-red-600 w-full sm:w-auto"
        >
          Search
        </button>
      </div>    
...
<div className="w-full md:w-4/5 lg:w-5/6 px-5">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {cruisesData.map((cruises, index) => (
        <div key={index} className="bg-gray-50 border-gray-100 p-3">
          <img src={cruises.imgSrc} alt="not found" className="w-full h-40 rounded mb-4" />
          <p className="text-gray-500 text-[16px] ml-2">{cruises.name}</p>
          <p className="text-red-500 font-bold text-[16px] ml-2">{cruises.price}</p>
